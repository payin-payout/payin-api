...
deliveryDescription | нет | Строка | Информация о доставке.
...
nspkUrl | нет | Строка | Для формирования платежной ссылки от НСПК требуется заполнить это поле, присвоив ему значение true
